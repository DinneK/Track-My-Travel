...
describe("DestinationsRepo", () => {
  ...
  beforeEach(() => {
    ...
    destination2 = new Destination(mockDestinationsData[8]);
  });

  it("should instantiate a new instance of DestinationsRepo", () => {
    expect(destinations).to.be.an.instanceOf(DestinationsRepo);
  });

  it("should have an list of destinations", () => {
    expect(destinations.destinations).to.deep.equal([
      {
        id: 1,
